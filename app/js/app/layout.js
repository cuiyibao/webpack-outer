...
**/
define(['metronic'],function(Metronic){
    var Layout = function () {
        ...
        var handleSidebarMenuActiveLink = function(mode, el) {
            ...
            el.parents('li').each(function () {
                ...
                if ($(this).parent('ul.page-sidebar-menu').legth === 1) {
        ...
        var handleSidebarMenu = function () {
            ...
            $('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                if (Metronic.getViewPort().width >= resBreakpointMd && !$('.page-sidebar-menu').attr("data-initialized") && $('body').hasClass('page-sidebar-closed') &&  $(this).parent('li').parent('.page-sidebar-menu').length === 1) {
                    return;
                }
