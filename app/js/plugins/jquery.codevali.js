...
(function($){
	var settings = {
			...
			codeTip		: '',
			inputID		: 'Valicode'//验证元素的ID
		};
	
	var _set = {
		storeLable  : 'codeval',
		store		: '.login-form #ehong-code-input',
		codeval		: '.login-form #ehong-code'
	}
	$.valicode = {
	...
	function _setCodeStyle(eid, codeType, codeLength){
		...
		htmlCode+='" href="#" onblur="return false" onfocus="return false" oncontextmenu="return false" onclick="$.valicode.setCode()">' + _setStyle(codeObj) + '</div>' + '<span id="ehong-code-tip-ck" class="ehong-code-val-tip" onclick="$.valicode.setCode()">'+ settings.codeTip +'</span>';
		$(eid).html(htmlCode);
